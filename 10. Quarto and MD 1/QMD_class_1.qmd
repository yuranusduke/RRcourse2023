...
|                                                                                                                                                                                                          |
|------------------------------------------------------------------------|
| [![Official YAML Logo.svg](//upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Official_YAML_Logo.svg/64px-Official_YAML_Logo.svg.png){alt="Official YAML Logo.svg"}](/wiki/File:Official_YAML_Logo.svg) |
| [Filename extensions](/wiki/Filename_extension "Filename extension")                                                                                                                                     |
| [Internet media type](/wiki/Media_type "Media type")                                                                                                                                                     |
| Initial release                                                                                                                                                                                          |
| [Latest release](/wiki/Software_release_life_cycle "Software release life cycle")                                                                                                                        |
| Type of format                                                                                                                                                                                           |
| [Open format](/wiki/Open_file_format "Open file format")?                                                                                                                                                |
| Website                                                                                                                                                                                                  |
